...
const processRegistration = async (req, res) => {
    ...
    try {
        ...
        // Save user to database (role_id will be set automatically by DEFAULT)
        await saveUser(
            name,
            email,
            hashedPassword
 ...
 * Passes the current logged-in user to the view for permission checks.
 */
 ...
 * Validates input and updates the user account.
 */
...
// GET /register/:id/edit - Display edit account form (requires login)
router.get(
    '/:id/edit',
    requireLogin,
    showEditAccountForm
...
// POST /register/:id/edit - Process account edit (requires login)
router.post(
    '/:id/edit',
    requireLogin,
    editValidation,
...
// POST /register/:id/delete - Delete user account (requires login)
router.post(
    '/:id/delete',
    requireLogin,
